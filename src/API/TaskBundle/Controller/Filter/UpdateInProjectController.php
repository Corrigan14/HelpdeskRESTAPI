...
/**
 * Class UpdateInProjectController
 *
 * @package API\TaskBundle\Controller\Filter
 */
class UpdateInProjectController extends ApiBaseController
{
     ...
     */
    public function updateAction(int $filterId, int $projectId, Request $request): Response
    {
        ...
        $dataValidation = $this->validateData($request, $filter, $project);
     ...
     * @throws \ReflectionException
     */
    private function validateData($request, $filter, $project): array
    {
        ...
        $permissionToUpdateFilter = $this->get('filter_voter')->isGranted(VoteOptions::UPDATE_PROJECT_FILTER, $options);
