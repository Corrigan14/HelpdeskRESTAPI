...
class ListController extends ApiBaseController
{
    ...
    public function listAction(Request $request): Response
    {
        ...
        $processedOrderParam = $this->get('task_process_order_param_service')->processOrderParam($requestBody['order']);
        ...
        $tasksArray = $this->get('task_service')->getTasksResponse($processedBasicFilterParams['page'], $options);
