...
class Project
{
     ...
     * @return Project
     */
    public function setIsActive($isActive): Project
    {
     ...
     * @return Project
     */
    public function addUserHasProject(UserHasProject $userHasProject): Project
    {
     ...
     * @return Project
     */
    public function addFilter(Filter $filter): Project
    {
        $this->filters[] = $filter;
     ...
     * @return Project
     */
    public function addImap(Imap $imap): Project
    {
        $this->imaps[] = $imap;
     ...
     * @return Project
     */
    public function addNotification(Notification $notification): Project
    {
