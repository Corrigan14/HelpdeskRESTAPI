...
class VoteOptions
{
    ...
    //REPEATING TASK
    const VIEW_REPEATING_TASK = 'view_repeating_task';
    const UPDATE_REPEATING_TASK = 'update_repeating_task';
    const CREATE_REPEATING_TASK = 'create_repeating_task';
    const DELETE_REPEATING_TASK = 'delete_repeating_task';
